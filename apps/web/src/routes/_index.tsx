	...
	return (
		...
		>
			<div className="flex flex-1 flex-col md:flex-row w-full">
				...
				<main
					className="flex-1 flex flex-col items-center px-2 py-8"
					...
					<section className="w-full flex flex-col items-center space-y-8">
						...
						>
							...
							<div className="mb-4" style={{ color: "var(--text-primary)" }}>
								IIITBuzz is a vibrant community forum built for IIIT students.
								Connect, discuss, ask questions, share resources, and stay
								updated with campus events—all in one place!
							</div>
						...
						>
							<article className="flex flex-col">
								<div className="flex items-center gap-3 px-6 pt-4">
									...
									<div>
										<div
											className="font-bold pixel-font text-base"
											style={{ color: "var(--primary)" }}
										>
								...
								<div
									className="px-6 pb-4 pt-2 text-sm font-body break-words"
